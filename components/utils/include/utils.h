...
#define LED_STATUS_PIN          GPIO_NUM_16
...
// Definiciones de hardware
// CAMBIO: GPIO 2 tenía conflicto con USB, cambiado a GPIO 16 para LED externo
#define LED_STATUS_PIN          GPIO_NUM_16  // LED externo (GPIO 2 conflicto USB)
...
esp_err_t calibration_load_from_nvs(calibration_data_t *cal_data);
esp_err_t calibration_clear_nvs(void);
// CAMBIO: Nueva función para limpiar completamente la partición NVS
